    ...
    data: [
      {
        ...
        image: "../assets/img/funitur1.jpeg",
        type: "all",
      },
      {
        label: "Kontak Pengrajin",
        subLabel: "Desain dapur minimalis",
        image: "../assets/img/funitur2.jpeg",
        type: "all",
      },
      {
        label: "Kontak Pengrajin",
        subLabel: "Renovasi dapur modern",
        image: "../assets/img/funitur3.jpeg",
        type: "all",
      },
      {
        label: "Kontak Pengrajin",
        subLabel: "Ruang Tamu Minimalis",
        image: "../assets/img/funitur4.jpeg",
        type: "all",
      },
      {
        label: "Kontak Pengrajin",
        subLabel: "Desain Interior",
        image: "../assets/img/funitur5.jpeg",
        type: "all",
      },
      {
        label: "Kontak Pengrajin",
