          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-services-three-item">
                <div className="services-icon">
                  <img
                    src="assets/img/icon/services-three-icon-2.svg"
                    alt="svg icon"
                  />
                </div>
                <div className="services-three-content">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-services-three-item">
                <div className="services-icon">
                  <img
                    src="assets/img/icon/services-three-icon-3.svg"
                    alt="svg icon"
                  />
                </div>
                <div className="services-three-content">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-services-three-item">
                <div className="services-icon">
                  <img
                    src="assets/img/icon/services-three-icon-4.svg"
                    alt="svg icon"
                  />
                </div>
                <div className="services-three-content">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-services-three-item">
                <div className="services-icon">
                  <img
                    src="assets/img/icon/services-three-icon-5.svg"
                    alt="svg icon"
                  />
                </div>
                <div className="services-three-content">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-services-three-item">
                <div className="services-icon">
                  <img
                    src="assets/img/icon/services-three-icon-6.svg"
                    alt="svg icon"
                  />
                </div>
                <div className="services-three-content">
